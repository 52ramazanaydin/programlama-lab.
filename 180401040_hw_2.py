#çalıştırmak için shelle /180401040_hw_2.py input_hw_2.csv 180401040_hw_2_output.txt 
...
def output(average, median):
    fnew = open(sys.argv[2], "w+") #fnew = open(sys.argv[2] + "180401040_hw_2_output.txt", "w+")
    fnew.write("Medyan = ")
